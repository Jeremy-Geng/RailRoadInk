...
/**
 * Test objective:
 * Determine whether a board string is split into individual placement strings where each placement has 5 characters
 */
...
public class SplitIntoIndividualPlacementStringsTest {
    ...
    /**
     * @param boardString represents the current state of the game
     * @param placements  the placement strings expected from RailroadInk.splitIntoIndividualPlacementStrings
     */
    private void testSplit(String boardString, String[] placements) {
        String[] individualPlaces = RailroadInk.splitIntoIndividualPlacementStrings(boardString);
        //individualPlaces must be of equal length to placements, and as the string is divided into 5 character pieces, the length of individualPlaces times 5 must be equal to the length of the boardString, additionally the first element in individualPlaces must have length equal to 5.
